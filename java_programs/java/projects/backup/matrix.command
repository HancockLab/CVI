...
###
vcf=/srv/netscratch/dep_coupland/grp_hancock/andrea/vcf/superVcf_19-05-15.vcf.b.gz_lyrata.vcf.b.gz_chrOnly.vcf.b.gz.vcf
...
matrix=/srv/netscratch/dep_coupland/grp_hancock/andrea/vcf/superMatrix_2019-05-15_wg_noHigCov_2.txt
	# /srv/netscratch/dep_coupland/grp_hancock/andrea/vcf/superMatrix_2019-05-15_wg_noHigCov.txt
...
# bcftools view -S ${samplesToKeep} --force-samples -r "Chr1","Chr2","Chr3","Chr4","Chr5" -I ${vcf} | bgzip -c > ${vcf}_cviLer.vcf.b.gz
# sleep 30s
...
matrix=/srv/netscratch/irg/grp_hancock/andrea/vcf/superMatrix_18-12-20_worldMadNewIberia.txt
	# /srv/netscratch/dep_coupland/grp_hancock/andrea/superMatrix_18-12-27.txt_plusAncXM.txt
