...
public class Pairwise_shore_cviMor {
	...
	public void setMatrixFile(String matrixName, String resultsPart, String wSize, String samplesSanto, String samplesFogo) {
		...
		try {
			...
			// Get sample IDs for population 1
			...
			// Get sample indexes in the SNP matrix
		...
		// Oldgood thing
			...
			// For pop1
			//
			Writer writer = new FileWriter(results + "pi_pop1.txt");
			PrintWriter out = new PrintWriter(writer);
			
			Writer writerSM = new FileWriter(results + "pi_pop1_Max.txt");
			...
			Writer writerW = new FileWriter(results + "thetaW_pop1.txt");
			...
			Writer writerT = new FileWriter(results + "tajd_pop1.txt");
			...
			// For Fogo
			//
			Writer writer2 = new FileWriter(results + "pi_pop2.txt");
			PrintWriter out2 = new PrintWriter(writer2);
			
			Writer writerFM = new FileWriter(results + "pi_pop2_Max.txt");
			...
			Writer writerW2 = new FileWriter(results + "thetaW_pop2.txt");
			...
			Writer writerfT = new FileWriter(results + "tajd_pop2.txt");
