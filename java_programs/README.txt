...
###
These java programs assume that you have the /java/ folder from GitHub in your home directory
...
To run these java progrms, enter the ./java/projects directory and you will find:

1) matrix_cvi.command:			Reads a VCF file (download from EVA) and creates a SNP matrix filtered for coverage and quality. Additionally, it creates a second matrix with the reconstructed ancestral state at every SNP, generated by ancestor_reconstruct.command
