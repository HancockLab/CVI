...
### full model A
# ${polyDfe}/./polyDFE-2.0-linux-64-bit -d ${inFile} -b params_basinhop.txt 1 -m A -i init_A.txt 2 -e -w > ${inFile}_A_nor_noeps_no_div
# ${polyDfe}/./polyDFE-2.0-linux-64-bit -d ${inFile} -b params_basinhop.txt 1 -m A -i init_A.txt 3 -e -w > ${inFile}_A_nor_no_div
# ${polyDfe}/./polyDFE-2.0-linux-64-bit -d ${inFile} -b params_basinhop.txt 1 -m A -i init_A.txt 4 -e -w > ${inFile}_A_noeps_no_div
# ${polyDfe}/./polyDFE-2.0-linux-64-bit -d ${inFile} -b params_basinhop.txt 1 -m A -i init_A.txt 1 -e -w > ${inFile}_A_no_div
# cat ${inFile}_A_nor_noeps_no_div >  ${inFile}_A_no_div.txt
# cat ${inFile}_A_nor_no_div       >> ${inFile}_A_no_div.txt
# cat ${inFile}_A_noeps_no_div     >> ${inFile}_A_no_div.txt
# cat ${inFile}_A_no_div           >> ${inFile}_A_no_div.txt
### full model C
# ${polyDfe}/./polyDFE-2.0-linux-64-bit -d ${inFile} -b params_basinhop.txt 1 -m C -i init_C.txt 2 -e -w > ${inFile}_C_nor_noeps_no_div
# ${polyDfe}/./polyDFE-2.0-linux-64-bit -d ${inFile} -b params_basinhop.txt 1 -m C -i init_C.txt 3 -e -w > ${inFile}_C_nor_no_div
# ${polyDfe}/./polyDFE-2.0-linux-64-bit -d ${inFile} -b params_basinhop.txt 1 -m C -i init_C.txt 4 -e -w > ${inFile}_C_noeps_no_div
# ${polyDfe}/./polyDFE-2.0-linux-64-bit -d ${inFile} -b params_basinhop.txt 1                         -w > ${inFile}_C_no_div
# cat ${inFile}_C_nor_noeps_no_div >  ${inFile}_C_no_div.txt
# cat ${inFile}_C_nor_no_div       >> ${inFile}_C_no_div.txt
# cat ${inFile}_C_noeps_no_div     >> ${inFile}_C_no_div.txt
# cat ${inFile}_C_no_div           >> ${inFile}_C_no_div.txt
### deleterious model
# ${polyDfe}/./polyDFE-2.0-linux-64-bit -d ${inFile} -b params_basinhop.txt 1 -m A -i init_A.txt 6 -e -w > ${inFile}_Del_nor_noeps_no_div
# ${polyDfe}/./polyDFE-2.0-linux-64-bit -d ${inFile} -b params_basinhop.txt 1 -m A -i init_A.txt 7 -e -w > ${inFile}_Del_nor_no_div
# ${polyDfe}/./polyDFE-2.0-linux-64-bit -d ${inFile} -b params_basinhop.txt 1 -m A -i init_A.txt 8 -e -w > ${inFile}_Del_noeps_no_div
# ${polyDfe}/./polyDFE-2.0-linux-64-bit -d ${inFile} -b params_basinhop.txt 1 -m A -i init_A.txt 5 -e -w > ${inFile}_Del_no_div
# cat ${inFile}_Del_nor_noeps_no_div >  ${inFile}_Del_no_div.txt
# cat ${inFile}_Del_nor_no_div       >> ${inFile}_Del_no_div.txt
# cat ${inFile}_Del_noeps_no_div     >> ${inFile}_Del_no_div.txt
# cat ${inFile}_Del_no_div           >> ${inFile}_Del_no_div.txt
...
# ${polyDfe}/./polyDFE-2.0-linux-64-bit -d ${santo} > ${polyDfe}/output/santo04fold_onePerStand_full_C
#  No Divergence data
