...
results=/srv/netscratch/dep_coupland/grp_hancock/andrea/pi/pi_cviRif_2020-01-08
	# /netscratch/dep_coupland/grp_hancock/andrea/pi_cviRif_19-02-04
mkdir -p ${results}_${1}
