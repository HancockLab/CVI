...
public class CallSlocus {
	...
	public void setSnpFile(String filename){
		...
		try {
			...
			while ( scanner.hasNextLine() ) { 
				...
				int chr = 1; 			// Just fake, to make mask read / write easy. Mask of Slocus will be just like chr1
			...
			// now revise zeroes in the mask, put 'N's in mpileup.all
	...
	public static void main(String[] args) {
		CallSlocus callSlocus = new CallSlocus();
		callSlocus.setSnpFile(args[0]); // args[0]
	}
}
