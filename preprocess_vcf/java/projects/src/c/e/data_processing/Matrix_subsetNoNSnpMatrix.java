...
public class Matrix_subsetNoNSnpMatrix {
	public Matrix_subsetNoNSnpMatrix() {}
	
	public void setMatrixFile(String matrixName, String sampleFile, String tag){
		
		try {
			Writer writer = new FileWriter(matrixName + "_" + tag + "_noN.txt");
			PrintWriter out = new PrintWriter(writer);
			
			Writer writerW = new FileWriter(matrixName + "_" + tag + "_genoWihs_noN.txt");
			PrintWriter outW = new PrintWriter(writerW);
			
			Writer writerP = new FileWriter(matrixName + "_" + tag + "_posWihs_noN.txt");
			PrintWriter outP = new PrintWriter(writerP);
			
			Writer writerN = new FileWriter(matrixName + "_" + tag + "_namesWihs_noN.txt");
	...
	public static void main(String[] args) {
		Matrix_subsetNoNSnpMatrix matrix_subsetNoNSnpMatrix = new Matrix_subsetNoNSnpMatrix();
		matrix_subsetNoNSnpMatrix.setMatrixFile(args[0], args[1], args[2]);
	}
}
