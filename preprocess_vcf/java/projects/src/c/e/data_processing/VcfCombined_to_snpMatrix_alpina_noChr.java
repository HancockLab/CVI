...
public class VcfCombined_to_snpMatrix_alpina_noChr {
	
	public VcfCombined_to_snpMatrix_alpina_noChr() {}
	...
	public void setFileToConvert(String filename, String outFile){
		...
		try {
			...
			Writer writer = new FileWriter(outFile + "_c3q15.txt");
	...
	public static void main(String[] args) {
		VcfCombined_to_snpMatrix_alpina_noChr vcfCombined_to_snpMatrix_alpina_noChr = new VcfCombined_to_snpMatrix_alpina_noChr();
		vcfCombined_to_snpMatrix_alpina_noChr.setFileToConvert(args[0], args[1]);
	}
}
