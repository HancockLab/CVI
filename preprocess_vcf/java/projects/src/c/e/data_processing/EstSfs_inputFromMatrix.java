...
public class EstSfs_inputFromMatrix {
	...
	public void setFileToSubSet(String matrixName, String outF){
		...
		try {
			...
			out1.print("chr" + "\t" + "pos" + "\t" + "cvi" + "\t" + "ha" + "\t" + "sma" + "\t" + "nma" + "\t" + "rif" + "\t" + "can" + "\n");
			...
			File sampleFile = new File("/srv/biodata/irg/grp_hancock/VCF/canarians_noOut.txt");
			...
			sampleFile = new File("/srv/biodata/irg/grp_hancock/VCF/capeVerdeos_clean_final_2020-05-20.txt");
				...
				// /srv/biodata/dep_coupland/grp_hancock/VCF/santos_clean_19-4-18.txt");
	    			// File sampleFile = new File("/srv/biodata/dep_coupland/grp_hancock/VCF/santos_clean_onePerStand.txt");
			scannerS = new Scanner(sampleFile);
	    		fil = 0;
			while ( scannerS.hasNextLine() ) {
				String snp = scannerS.nextLine();
			...
			String[] focus = pop1;
			int maxN = (int) Math.round(1*focus.length/2);
			...
			for (int o=0; o<outInd.length; o++) {
				System.out.println(Arrays.toString(outInd[o]));
			}
			System.out.println(Arrays.toString(focInd));
