...
public class GeneVcfVariants {
	public GeneVcfVariants() {}
	...
	public static void main(String[] args) {
		GeneVcfVariants geneVcfVariants = new GeneVcfVariants();
		geneVcfVariants.setFold(args[0], args[1]);
	}
}
