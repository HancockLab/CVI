...
public class Mor_private_haps {
	
	private int whichCountry = 0;
	private Mor_private_haps() {}
	
	public void runTheMatrix(String matrixName) {
		try {
			...
			Writer writer = new FileWriter(matrixName + "_privateHapsPerCountry.txt");
			...
			while (scannerMatrix.hasNextLine()) {
    			...
    			for (int b=0; b<allIndexes.length; b++) {
    				...
    				if (base != 'N') {
    	    			...
    	    			if (allN) {
    	    				System.out.println("AllN at: " + snp);
    	    			}
	...
	public static void main(String[] args) {
		Mor_private_haps mor_private_haps = new Mor_private_haps();
		mor_private_haps.runTheMatrix(args[0]);
	}
}
