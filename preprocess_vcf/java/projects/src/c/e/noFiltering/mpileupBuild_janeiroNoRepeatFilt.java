...
public class mpileupBuild_janeiroNoRepeatFilt {
	...
	public mpileupBuild_janeiroNoRepeatFilt() {}
	...
	public void setSnpFile(String filename){
		...
		try {
			...
			String wereWe = "/home/CIBIV/andreaf/canaries/rawData/analyses/checkFiltering/noRepeatFilt";

			fileMpileup = new File(filename);
			Scanner scanner = new Scanner(fileMpileup);
			
			
            String wereWeResults = "/scratch/noRepeatFilt/";
			...
			while ( scanner.hasNextLine() ) { 
	        	...
	        	if ( splitSnp1[0].charAt(0) == 'C' && splitSnp1[0].charAt(1) == 'h' && splitSnp1[0].charAt(2) == 'r') {
		        	...
		        	// This eliminate for filtering >= 5 bp repeats until //END repeats
	...
	public static void main(String[] args) {
		mpileupBuild_janeiroNoRepeatFilt MpileupBuild_janeiroNoRepeatFilt = new mpileupBuild_janeiroNoRepeatFilt();
		MpileupBuild_janeiroNoRepeatFilt.setSnpFile(args[0]); // args[0]
