...
public class mpileupBuild_janeiroAllFilt {
	...
	public mpileupBuild_janeiroAllFilt() {}
	...
	public void setSnpFile(String filename){
		...
		try {
			...
			String wereWe = "/home/CIBIV/andreaf/canaries/rawData/analyses/checkFiltering/allFilters2";

			fileMpileup = new File(filename);
			Scanner scanner = new Scanner(fileMpileup);
			
            String wereWeResults = "/scratch/allFilters2/";
			...
			Writer writerAll = new FileWriter("/scratch/allFilters/" + filename + ".all");
	...
	public static void main(String[] args) {
		mpileupBuild_janeiroAllFilt MpileupBuild_janeiroAllFilt = new mpileupBuild_janeiroAllFilt();
		MpileupBuild_janeiroAllFilt.setSnpFile(args[0]); // args[0]
	}
}
