...
public class mpileupBuild_janeiroCoverageLasso {
	...
	public mpileupBuild_janeiroCoverageLasso() {}
	...
	public void setSnpFile(String filename){
		...
		try {
			...
			String wereWe = "/home/CIBIV/andreaf/canaries/rawData/analyses/checkFiltering/covLassoFilters";

			fileMpileup = new File(filename);
			Scanner scanner = new Scanner(fileMpileup);
			
			
            String wereWeResults = "/scratch/covLassoFilters/";
	...
	public static void main(String[] args) {
		mpileupBuild_janeiroCoverageLasso MpileupBuild_janeiroCoverageLasso = new mpileupBuild_janeiroCoverageLasso();
		MpileupBuild_janeiroCoverageLasso.setSnpFile(args[0]); // args[0]
