...
public class mpileupBuild_janeiroNoSnpsTooClose {
	...
	public mpileupBuild_janeiroNoSnpsTooClose() {}
	...
	public void setSnpFile(String filename){
		...
		try {
			...
			String wereWe = "/home/CIBIV/andreaf/canaries/rawData/analyses/checkFiltering/noSnpsTooCloseFilters";

			fileMpileup = new File(filename);
			Scanner scanner = new Scanner(fileMpileup);
			
			
            String wereWeResults = "/scratch/noSnpsTooCloseFilters/";
	...
	public static void main(String[] args) {
		mpileupBuild_janeiroNoSnpsTooClose MpileupBuild_janeiroNoSnpsTooClose = new mpileupBuild_janeiroNoSnpsTooClose();
		MpileupBuild_janeiroNoSnpsTooClose.setSnpFile(args[0]); // args[0]
