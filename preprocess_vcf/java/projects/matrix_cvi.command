...
# 		If not so, you will need to change a bunch of paths (e.g. to the libraries in ./java/lib/)
###
###
...
#
cat ${matrix}_c5q25_chr1.txt ${matrix}_c5q25_chr2.txt ${matrix}_c5q25_chr3.txt ${matrix}_c5q25_chr4.txt ${matrix}_c5q25_chr5.txt > ${matrix}
sleep 30s
