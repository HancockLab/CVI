...
# dfe = t(sapply(est, getDiscretizedDFE, sRanges = c(-100, -10, -5, -1, 0, 1, 5, 10)))
...
# colnames(dfe) = toNames(c(-100, -10, -5, -1, 0, 1, 5, 10))
print(dfe)
...
# colnames(dfe) = c( "<-10\u00B2", "-10\u00B2,-10", "-10,-5", "-5,-1", "-1,0", "0,1", "1,5", "5,10", "10<")
