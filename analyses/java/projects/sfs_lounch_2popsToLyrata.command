...
samplesOutgroup=./data/lyrata_plink_minus2badQ_2019-11-07.txt
mask=./data/TAIR10_GFF3_genes_transposons.gff_interG_superMask_fromGff.txt
maskRepeats=./data/masks_cvi_func/repeatCentromCpg_out_mask.txt
gzip -cd ${mask}.gz > ${mask}
gzip -cd ${maskRepeats}.gz > ${maskRepeats}

#
for samples1 in ./data/capeVerdeos_clean_final_2021-01-18.txt
	# For Santo Antao Versus Fogo:
	# for samples1 in ./data/santos_clean_2021-01-18.txt
do
	for samples2 in ./data/morocco.txt
		# For Santo Antao versus Fogo:
