...
# results=
	# /srv/netscratch/dep_coupland/grp_hancock/andrea/pogo_tanz_2020
	# /srv/netscratch/dep_coupland/grp_hancock/andrea/pogo_sAfrica
	# /srv/netscratch/dep_coupland/grp_hancock/andrea/pogo_kenya
# mkdir -p ${results}
# /home/fulgione/bird_genomes/pogoniulus_tanz_chrysoconus_dipFullNames.txt  /home/fulgione/bird_genomes/pogoniulus_tanz_pusillus_dipFullNames.txt
...
#
for samples1 in /home/fulgione/highAtlas.txt /home/fulgione/southMiddleAtlas.txt /home/fulgione/northMiddleAtlas.txt /home/fulgione/morocco.txt
...
# 	
for samples2 in /srv/biodata/dep_coupland/grp_hancock/VCF/santos_clean_19-04-23_noLastLanes.txt /srv/biodata/dep_coupland/grp_hancock/VCF/fogos_clean_19-04-23_noLastLanes.txt /srv/biodata/dep_coupland/grp_hancock/VCF/capeVerdeos_clean_19-04-23_final.txt
...
do
	...
	samplesOutgroup=/srv/biodata/dep_coupland/grp_hancock/VCF/lyrata_plink_minus2badQ_2019-11-07.txt
	...
	results=/srv/netscratch/dep_coupland/grp_hancock/andrea/sfs_cvi-mor_2020-07-18/${short1}-${short2}/
	mkdir -p ${results}
	echo ${results}
...
# java -Xmx4G -classpath ~/java/lib/junit.jar:~/java/lib/jbzip2-0.9.1.jar:~/java/lib/args4j-2.0.12.jar:~/java/lib/commons-compress-1.0.jar:~/java/lib/gson-1.6-javadoc.jar:~/java/lib/gson-1.6-sources.jar:~/java/lib/gson-1.6.jar:bin c.e.data_processing.Matrix_getJSFS_generalAndPogoniulus ${matrix} null ${results}/pogo ${samples1} ${samples2} ${samplesOutgroup}
	...
	# java -Xmx4G -classpath ~/java/lib/junit.jar:~/java/lib/jbzip2-0.9.1.jar:~/java/lib/args4j-2.0.12.jar:~/java/lib/commons-compress-1.0.jar:~/java/lib/gson-1.6-javadoc.jar:~/java/lib/gson-1.6-sources.jar:~/java/lib/gson-1.6.jar:bin c.e.data_processing.Matrix_getJSFS_polLyrata_2pops ${matrix} ${mask} ${results} ${samples1} ${samples2} ${samplesOutgroup}
done
done
