...
matrix=/srv/netscratch/irg/grp_hancock/andrea/vcf/superMatrix_s1-1_2020-09-25_wg_noHigCov.txt_plusAncXM.txt
	# The matrix used for main analyses, aligned to TAIR10
	# 
	# /srv/netscratch/dep_coupland/grp_hancock/andrea/vcf/superMatrix_2019-11-07_cviMorLyrLer_noHigCov_2020-05-20.txt_plusAncXM.txt
	# /srv/netscratch/dep_coupland/grp_hancock/andrea/vcf/superMatrix_2019-11-07_cviMorLyrLer_noHigCov.txt_plusAncXM.txt
	# /srv/netscratch/dep_coupland/grp_hancock/andrea/vcf/superMatrix_19-04-23.txt_plusAncXM.txt # eliminate SNPs only in general
	# /srv/biodata/dep_coupland/grp_hancock/andrea/superMatrix_2-7-18_final.txt_plusAncXM.txt
	# /netscratch/dep_coupland/grp_hancock/andrea/vcf/superMatrix_cvi0_19-01-07.txt
	# /netscratch/dep_coupland/grp_hancock/andrea/vcf/superMatrix_cvi0_19-01-07.txt
	# the one I used for all calculations:
	# /srv/biodata/dep_coupland/grp_hancock/andrea/superMatrix_2-7-18_final.txt_plusAncXM.txt
	#
...
tag0=s1-1_2020-10-03_5percN_noLastLanes
	# 2020-06-08_5percN_noLastLanes
	# 2020-05-21
...
for file in fourFold.command zeroFold.command # wg.command interg.command # fourFold.command zeroFold.command # lowImpact.command modifierImpact.command syn.command nonSyn.command # interg.command wg.command fourFold.command zeroFold.command cns.command utr.command highImpact.command lowImpact.command modifierImpact.command syn.command nonSyn.command
...
do
	...
	do
		...
		sant=/srv/biodata/irg/grp_hancock/VCF/santos_clean_19-04-23_noLastLanes.txt
			# /srv/biodata/dep_coupland/grp_hancock/VCF/santos_clean_19-04-23.txt
			# /srv/biodata/dep_coupland/grp_hancock/VCF/capeVerdeos_clean_19-04-23.txt
			# /srv/biodata/dep_coupland/grp_hancock/VCF/santos_clean_19-04-23.txt
			# /srv/biodata/dep_coupland/grp_hancock/VCF/santos_clean_19-04-23.txt
			# /home/fulgione/java/projects/s20_main.txt
			# /srv/biodata/dep_coupland/grp_hancock/VCF/SforSlim.txt
		...
		do
			...
			#then
				...
				fog=/srv/biodata/irg/grp_hancock/VCF/fogos_clean_19-04-23_noLastLanes.txt
					# /srv/biodata/dep_coupland/grp_hancock/VCF/fogos_clean_19-04-23.txt
					# /srv/biodata/dep_coupland/grp_hancock/VCF/santos_clean_s1-8.txt
					# /srv/biodata/dep_coupland/grp_hancock/VCF/fogos_clean_19-04-23.txt
					# /srv/biodata/dep_coupland/grp_hancock/VCF/fogos_clean_19-04-23.txt
					# /srv/biodata/dep_coupland/grp_hancock/VCF/fogos_clean_11-7-18.txt
					# /srv/biodata/dep_coupland/grp_hancock/VCF/fogos_clean_onePerStand.txt
				mask="$(echo ${file} | cut -d '.' -f 1)"
				tag1=/srv/netscratch/irg/grp_hancock/andrea/sfs/sfs_${mask}_${tag0}
				mkdir -p ${tag1}
				tag=${tag1}/clean_2020-04-27_sub40
					# ${pops[s]}-${pops[f]}
				echo ${tag}
				# ./${file} ${matrix} ${tag} ${sant} ${fog}
				bsub -q multicore40 -n 1 -R "span[hosts=1] rusage[mem=26000]" -M 30000 "./${file} ${matrix} ${tag} ${sant} ${fog}"
			#fi
		done
	done
done
