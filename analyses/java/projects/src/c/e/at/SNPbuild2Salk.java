...
public class SNPbuild2Salk {
	...
	public void setSnpFile(String filename){
		...
		try {
			...
			Writer writer1 = new FileWriter("/home/CIBIV/andreaf/canaries/rawData/Cvi0_Salk.allVar");
			PrintWriter out1 = new PrintWriter(writer1);
			
			Writer writer2 = new FileWriter("/home/CIBIV/andreaf/canaries/rawData/Cvi0_Salk.snp2");
			PrintWriter out2 = new PrintWriter(writer2);
			
			Writer writer3 = new FileWriter("/home/CIBIV/andreaf/canaries/rawData/Cvi0_Salk.indel");
			...
			snp1 = scanner.nextLine();
	        	...
	        	if (splitSnp1[0].charAt(0) != '#') {
	        		...
	        		if ( splitSnp1[0].charAt(0) == 'C' && splitSnp1[0].charAt(1) == 'h' && splitSnp1[0].charAt(2) == 'r') {
						...
						String ref = splitSnp1[3];
                                                reference = ref.split("");

		        			int in = variant.length;
		        			// System.out.println(Arrays.toString(variant));
						int del = reference.length;
	...
	public static void main(String[] args) {
		SNPbuild2Salk sNPbuild2Salk = new SNPbuild2Salk();
		sNPbuild2Salk.setSnpFile("/home/CIBIV/andreaf/canaries/rawData/Cvi-0_salk.sam.sortP.sam.duprem.sam.bam.mq20.bam_-gq_noQD.vcf");  
	}
}
