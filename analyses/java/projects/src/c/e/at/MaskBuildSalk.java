...
//	private Boolean region = null;
	...
	public void setSnpFile(String filename){
		...
		try {
			...
			Writer writer = new FileWriter("/home/CIBIV/andreaf/canaries/rawData/java/Mask_cvi0_Salk.txt");
	...
	public static void main(String[] args) {
		...
		MaskBuildSalk maskBuildSalk = new MaskBuildSalk();
		maskBuildSalk.setSnpFile("/home/CIBIV/andreaf/canaries/rawData/Cvi-0_salk.sam.sortP.sam.duprem.sam.bam.mq20.bam.mpileup"); 
