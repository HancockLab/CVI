...
public class mpileupBuild_janeiro {
	...
	public void setSnpFile(String filename){
		...
		try {
			...
			Writer writer1 = new FileWriter(filename + ".hets"); //  filename + ".hets"
			PrintWriter out1 = new PrintWriter(writer1);
			
			Writer writer2 = new FileWriter(filename + ".snp"); //  filename + ".snp"
			PrintWriter out2 = new PrintWriter(writer2);
			
			Writer writer3 = new FileWriter(filename + ".indel"); //  filename + ".indel"
			PrintWriter out3 = new PrintWriter(writer3);
			
			Writer writer4 = new FileWriter(filename + ".strangeSites"); //  filename + ".strangeSites"
			PrintWriter out4 = new PrintWriter(writer4);
			
			Writer writer5 = new FileWriter(filename + ".all_intermediate2");
			...
			Writer writer = new FileWriter(filename + ".mask.txt"); //  filename + ".mask.txt"
			...
			Writer writerAll = new FileWriter(filename + ".all");
			PrintWriter outAll = new PrintWriter(writerAll);
			
			Writer writerAllVar = new FileWriter(filename + ".all.Var");
			PrintWriter outAllVar = new PrintWriter(writerAllVar);
			
			Writer writerSnp = new FileWriter(filename + ".all.snp");
			PrintWriter outSnp = new PrintWriter(writerSnp);
			
			File fileIntermediate = new File(filename + ".all_intermediate2"); // filename + ".all_intermediate2"
	...
	public static void main(String[] args) {
		mpileupBuild_janeiro MpileupBuild_janeiro = new mpileupBuild_janeiro();
		MpileupBuild_janeiro.setSnpFile(args[0]); // args[0]
