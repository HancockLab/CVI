...
//	private Boolean region = null;
	...
	public void setSnpFile(String filename){
		...
		try {
			...
			*/
			...
			whereWe = "/home/CIBIV/andreaf/canaries/rawData/analyses/PCA_ADM/analyses/polMatrLaneDec/";
		...
		for (int c=0; c<5; c++) {
			...
			folder = new File("/home/CIBIV/andreaf/canaries/rawData/analyses/PCA_ADM/dataAdm/");
			...
			if (accession == 0) {
				...
				Writer writerP = new FileWriter("/home/CIBIV/andreaf/canaries/rawData/analyses/PCA_ADM/analyses/polarized_matrix/PCA_params.txt");
				...
				Writer writerA = new FileWriter("/home/CIBIV/andreaf/canaries/rawData/analyses/PCA_ADM/analyses/polarized_matrix/ADM_params.map");
				...
				Writer writerN = new FileWriter("/home/CIBIV/andreaf/canaries/rawData/analyses/PCA_ADM/analyses/polarized_matrix/ADM_AccessionNames.txt");
			...
			Writer writer = new FileWriter("/home/CIBIV/andreaf/canaries/rawData/analyses/PCA_ADM/analyses/polarized_matrix/PCA_" + accession + ".txt", true);
	...
	public static void main(String[] args) {
		PolarizedMatrix polarizedMatrix = new PolarizedMatrix();
		polarizedMatrix.setSnpFile(args[0]);
	}
}
