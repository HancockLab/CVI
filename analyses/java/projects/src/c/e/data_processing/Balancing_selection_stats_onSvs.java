...
public class Balancing_selection_stats_onSvs {
	
	public Balancing_selection_stats_onSvs() {}
...
///// Erase until here 
			...
			for (int f=0; f<files.length; f++) {
				...
				Writer writer2 = new FileWriter(sampleFile + "_" + localName + "_balSelStats_forBootstrap_5.txt");
			...
			Writer writer = new FileWriter(sampleFile + "_balSelStats_5.txt");
	...
	public static void main(String[] args) {
		Balancing_selection_stats_onSvs balancing_selection_stats_onSvs = new Balancing_selection_stats_onSvs();
		balancing_selection_stats_onSvs.setFileToSubSet(args[0], args[1], args[2], args[3], args[4]);
	}
}
