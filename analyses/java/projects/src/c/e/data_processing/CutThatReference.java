...
public class CutThatReference {
	...
	public void setFile(String fileName, String sampleStr){
		...
		// Checked matrix entries,
			...
			String results = "/global/lv70590/Andrea/analyses/sharedStuff/refCut_mut/sameMut10/";
			
			for (int repl=sample; repl<sample+1; repl++) {
			//	System.out.println("sample: " + samp);
				...
				Writer writer = new FileWriter(fileName + "check_sameMut.txt");
				...
				// Mutate reference
				Writer writer3 = new FileWriter(results + repl + "_realSameMuts.txt"); // samp + "_realMuts.txt");
			...
			for (int samp=0; samp<11; samp++) {
				...
				Writer writer2 = new FileWriter(results + repl + "_" + samp + "_sameMut.fastq");
