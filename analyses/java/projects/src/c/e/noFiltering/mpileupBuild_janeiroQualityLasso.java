...
public class mpileupBuild_janeiroQualityLasso {
	...
	public mpileupBuild_janeiroQualityLasso() {}
	...
	public void setSnpFile(String filename){
		...
		try {
			...
			String wereWe = "/home/CIBIV/andreaf/canaries/rawData/analyses/checkFiltering/qualityLasso20";

			fileMpileup = new File(filename);
			Scanner scanner = new Scanner(fileMpileup);
			
			
            String wereWeResults = "/scratch/qualityLasso20/";
	...
	public static void main(String[] args) {
		mpileupBuild_janeiroQualityLasso MpileupBuild_janeiroQualityLasso = new mpileupBuild_janeiroQualityLasso();
		MpileupBuild_janeiroQualityLasso.setSnpFile(args[0]); // args[0]
