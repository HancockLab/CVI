...
public class mpileupBuild_janeiroNoFiltersLowQC2 {
	...
	public mpileupBuild_janeiroNoFiltersLowQC2() {}
	...
	public void setSnpFile(String filename){
		...
		try {
			...
			String wereWe = "/home/CIBIV/andreaf/canaries/rawData/analyses/checkFiltering/noFiltersLowQC";

			fileMpileup = new File(filename);
			Scanner scanner = new Scanner(fileMpileup);
			
			
            String wereWeResults = "/scratch/noFiltersLowQC/";
	...
	public static void main(String[] args) {
		mpileupBuild_janeiroNoFiltersLowQC2 MpileupBuild_janeiroNoFiltersLowQC2 = new mpileupBuild_janeiroNoFiltersLowQC2();
		MpileupBuild_janeiroNoFiltersLowQC2.setSnpFile(args[0]); // args[0]
