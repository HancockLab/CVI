...
public class mpileupBuild_janeiroAllFilt_forPogoniulus {
	...
	public mpileupBuild_janeiroAllFilt_forPogoniulus() {}
	...
	public void setSnpFile(String filename, String wereWeResults){
		...
		try {
			...
			Writer writerLog = new FileWriter(wereWeResults + localName + ".log.txt");
				...
				outLog.print(snp1 + "\t");
	        		...
	        		if (jump == 0) {
						...
						// System.out.println(Arrays.toString(quality));
	        					...
	        					if ( variant[run].charAt(0) != '$' ) {
		        					if (variant[run].charAt(0) == '^') {
										...
										if (variant[run+1].matches("-?(0|[1-9]\\d*)")) {
											...
											outLog.print(((int)(quality[r].charAt(0)) - 33) + "-");
		        			...
		        			outLog.print(aa + "\t" + aA + "\t" +tt + "\t" +tT + "\t" +cc + "\t" +cC + "\t" +gg + "\t" +gG + "\n");
				...
				if (chromOut) {
					System.out.println("Problem at chrom: " + chrString + "\t" + Arrays.toString(chroms));
						...
						if (splitSnp1[6].charAt(0) != 'N' && splitSnp1[6].charAt(0) != 'S' && splitSnp1[6].charAt(0) != '-') {
							...
							outSnpEff.print(splitSnp1[0] + "\t" + splitSnp1[1] + "\t" + "." + "\t" + splitSnp1[2] + "\t" +splitSnp1[6] + "\t" + "." + "\t" +  "PASS" + "\t" + "." + "\tGT\t./.\n");
						}
	...
	public static void main(String[] args) {
		mpileupBuild_janeiroAllFilt_forPogoniulus MpileupBuild_janeiroAllFilt_forPogoniulus = new mpileupBuild_janeiroAllFilt_forPogoniulus();
		MpileupBuild_janeiroAllFilt_forPogoniulus.setSnpFile(args[0], args[1]);
	}
}
