...
public class mpileupBuild_janeiroTemplate {
	...
	public mpileupBuild_janeiroTemplate() {}
	...
	public void setSnpFile(String filename){
		...
		try {
			...
			String wereWe = "/home/CIBIV/andreaf/canaries/rawData/analyses/checkFiltering/templateFilters";

			fileMpileup = new File(filename);
			Scanner scanner = new Scanner(fileMpileup);
			
			
            String wereWeResults = "/scratch/templateFilters/";
	...
	public static void main(String[] args) {
		mpileupBuild_janeiroTemplate MpileupBuild_janeiroTemplate = new mpileupBuild_janeiroTemplate();
		MpileupBuild_janeiroTemplate.setSnpFile(args[0]); // args[0]
