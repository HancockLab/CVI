...
public class mpileupBuild_janeiroNoRefSecondInRatio {
	...
	public mpileupBuild_janeiroNoRefSecondInRatio() {}
	...
	public void setSnpFile(String filename){
		...
		try {
			...
			String wereWe = "/home/CIBIV/andreaf/canaries/rawData/analyses/checkFiltering/noRefSecondInRatioFilters";

			fileMpileup = new File(filename);
			Scanner scanner = new Scanner(fileMpileup);
			
			
            String wereWeResults = "/scratch/noRefSecondInRatioFilters/";
	...
	public static void main(String[] args) {
		mpileupBuild_janeiroNoRefSecondInRatio MpileupBuild_janeiroNoRefSecondInRatio = new mpileupBuild_janeiroNoRefSecondInRatio();
		MpileupBuild_janeiroNoRefSecondInRatio.setSnpFile(args[0]); // args[0]
