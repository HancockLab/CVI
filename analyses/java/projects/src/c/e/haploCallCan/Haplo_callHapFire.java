...
public class Haplo_callHapFire {
	
	private int whichCountry = 0;
	private Haplo_callHapFire() {}
	
	public void haplo_filter_overlaps(String hapPartialCall) {
		try {
	...
	public static void main(String[] args) {
		Haplo_callHapFire haplo_callHapFire = new Haplo_callHapFire();
		...
		haplo_callHapFire.haplo_filter_overlaps("/home/CIBIV/andreaf/canaries/rawData/analyses/haplotypeCallsCan/canHaploCallsFire_varWit_");
	}
}
