...
public class Haplo_ageMyHapCalls {
	
	private int whichCountry = 0;
	private Haplo_ageMyHapCalls() {}
	...
	public void fromHapCallsToHapFS(String matrixName, String canarian) {
			...
			// GOT potential haplotypes of the 2 kinds
		    	...
		    	if (cardOverlap != 0) {
					...
					for (int c=0; c<5; c++) {
						...
						// 1 if it was migrant 
						// 2 if it was neither 
						// - should not happen that they were overlapping already
						int hapEntrance = 3;
						int hapExit = 3;
					...
					System.out.println("Moroccan hap bigger than Iberian hap: " + "\t" + hapOverlap[0]);
					System.out.println("Iberian hap bigger than Moroccan hap: " + "\t" + hapOverlap[1]);
        ...
        public static void main(String[] args) {
        	Haplo_ageMyHapCalls haplo_ageMyHapCalls = new Haplo_ageMyHapCalls();
        	haplo_ageMyHapCalls.fromHapCallsToHapFS(args[0], args[1]);
	}
}
