...
###
#       Check percentage private SNPs from Novikova et al.
###
thaliana_lyrata_percShared = 21247/(130533 + 460105)
thaliana_alleri_percShared = 10844/(142188 + 207627)
thaliana_arenosa_percShared = 27287/(118219 + 637739)
halleri_lyrata_percShared = 104927/(197633 + 481334)
halleri_arenosa_percShared = 105561/(177333 + 663998)
lyrata_arenosa_percShared = 293189/(421502 + 646748)

percShared_arabSpecies=c(thaliana_lyrata_percShared, thaliana_alleri_percShared, thaliana_arenosa_percShared, halleri_lyrata_percShared, halleri_arenosa_percShared, lyrata_arenosa_percShared)

range(1-percShared_arabSpecies)
...
# Cvi-Mor
jsfs = as.matrix(read.table("./data/cvi-mor_2021-02-16_sub40_jsfsX.txt", head=F))
...
# 4-fold: 1-0.01803279        # 0.9819672
# Morocco: 1-0.0006144124     # 0.9993856
# Mor 4-fold: 1-0.0007367646  # 0.9992632
...
# CVI islands:
#
pdf("./fig_jsfs_cviMor.pdf", width=2.2, height=1.6)
# 
